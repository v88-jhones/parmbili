...
const Parmbili = () => {
    ...
    return (
        <div className="parmbili_container">
            <div className="parmbili">
                <div className={`tiles_container ${dimensionStyle[land_square]}`}>
                    {tiles.map(tile => <Tile key={tile.id} tile={tile} />)}
                </div>
                <p className="earnings">Total Earnings: {earnings}$</p>
                {
